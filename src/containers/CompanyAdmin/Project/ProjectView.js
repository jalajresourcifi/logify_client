                ...
                <div className="kt-widget kt-widget--user-profile-3">
                  <div className="kt-widget__top">
                    ...
                    <div className="kt-widget__content">
                      ...
                      <div className="kt-widget__subhead kt-hidden">
                        <Link to="">
                          <i className="flaticon2-new-email"></i>jason@siastudio.com
                        </Link>
                        <Link to="">
                          <i className="flaticon2-calendar-3"></i>PR Manager{" "}
                        </Link>
                        <Link to="">
                          <i className="flaticon2-placeholder"></i>Melbourne
                        </Link>
                      </div>
                      <div className="kt-widget__info">
                        <div className="kt-widget__desc">
                          I distinguish three main text objektive.First, your
                          could
                          <br /> be merely to inform people a second could be
                          persuade people.
                          <br /> You want people to bay your products
                        </div>
                        <div className="kt-widget__progress kt-hidden">
                          <div className="kt-widget__text">Progress</div>
                        ...
                        <div className="kt-widget__stats d-flex align-items-center flex-fill">
                          ...
                          <div className="kt-widget__item flex-fill">
                            ...
                            <div className="kt-widget__progress d-flex  align-items-center">
                              ...
                              <span className="kt-widget__stat">78%</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="kt-widget__bottom">
                    <div className="kt-widget__item">
                      ...
                      <div className="kt-widget__details">
                        <span className="kt-widget__title">Budget</span>
                    ...
                    <div className="kt-widget__item">
                      ...
                      <div className="kt-widget__details">
                        <span className="kt-widget__title">Received Amount</span>
                        <span className="kt-widget__value">
                          <span>$</span>164,700
                        </span>
                      </div>
                    ...
                    <div className="kt-widget__item">
                      ...
                      <div className="kt-widget__details">
                        <span className="kt-widget__title">Due Amount</span>
                        <span className="kt-widget__value">
                          <span>$</span>84,060
                        </span>
                      </div>
                      ...
                      <div className="kt-widget__details">
                        <div className="kt-section__content kt-section__content--solid">
                          <div className="kt-badge kt-badge__pics">
                            ...
                            <Link
                              to=""
                              className="kt-badge__pic kt-badge__pic--last kt-font-brand"
                            >
                              +7
                            </Link>
                          </div>
                ...
                <div className="kt-portlet kt-portlet--height-fluid">
                  <div className="kt-portlet__head">
                    <div className="kt-portlet__head-label">
                      <h3 className="kt-portlet__head-title">Order Statistics</h3>
                    </div>
                  </div>
                        ...
                        <div className="kt-widget2">
                          ...
                          <div className="kt-widget2__item kt-widget2__item--success">
                            ...
                            <div className="kt-widget2__info">
                              ...
                              <Link className="kt-widget2__username">By James</Link>
                            </div>
                            <div className="kt-widget2__actions">
                              <Link
                                to=""
                  ...
                  <div className="kt-portlet__body">
                    ...
                    <div className="kt-widget4">
                      ...
                      <div className="kt-widget4__item">
                        ...
                        <span className="kt-widget4__number kt-font-danger">
                          +1080
                        </span>
                      </div>
                      <div className="kt-widget4__item">
                      ...
                      <div className="kt-widget4__item">
                        ...
                        <span className="kt-widget4__number kt-font-brand">
                          +134
                        </span>
                      </div>
                      <div className="kt-widget4__item">
                        ...
                        <Link
                          ...
                          className="kt-widget4__title kt-widget4__title--light"
                        >
                          Black Friday! Purchase Metronic at ever lowest 90% off
                          for limited time
                        </Link>
