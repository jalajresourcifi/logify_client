                  ...
                  <div className="kt-widget__top">
                    ...
                    <div className="kt-widget__content">
                      ...
                      <div className="kt-widget__subhead">
                        ...
                        <Link to="">
                          <i className="flaticon2-calendar-3"></i>Designation
                        </Link>
                        <Link to="">
                          <i className="flaticon2-phone"></i>+91-999999999
                        </Link>
                        <Link to="">
                          <i className="flaticon2-calendar-3"></i>Washington
                          D.C, US
                        </Link>
                      </div>
                  ...
                  <div className="kt-widget__bottom">
                    <div className="kt-widget__item">
                      ...
                      <div className="kt-widget__details">
                        <span className="kt-widget__title">Project Name</span>
                    ...
                    <div className="kt-widget__item">
                      ...
                      <div className="kt-widget__details">
                        <span className="kt-widget__title">Technology</span>

                        <span className="kt-widget__value">
                          <span></span>Angular, ReactJS
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="kt-widget__content">
                      ...
                      <div className="kt-widget__info">
                        ...
                        <div className="kt-widget__progress">
                          ...
                          <div className="progress">
                            <div
                              className="progress-bar kt-bg-danger wide-20"
                              role="progressbar"
                              aria-valuenow="65"
                              aria-valuemin="0"
                              aria-valuemax="100"
                          ...
                          <div className="kt-widget__stats">20%</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="kt-widget__content">
                      ...
                      <div className="kt-widget__info">
                        ...
                        <div className="kt-widget__progress">
                          ...
                          <div className="kt-widget__stats">85%</div>
                        </div>
                      </div>
                    </div>
                  </div>
