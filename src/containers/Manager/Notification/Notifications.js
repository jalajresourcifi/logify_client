...
<div className="kt-subheader  kt-grid__item" id="kt_subheader">
  <div className="kt-container  kt-container--fluid ">
    <div className="kt-subheader__main">
      <h3 className="kt-subheader__title">Notifications</h3>
    ...
    <div className="col-xl-12 col-lg-12">
      ...
      <div className="kt-portlet kt-portlet--height-fluid">
        ...
        <div className="kt-portlet__body">
          <div className="">
            <div className="" id="kt_widget6_tab1_content" aria-expanded="true">
              <div className="kt-notification">
                <Link to="" className="kt-notification__item">
                  <div className="kt-notification__item-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--brand">
          ...
          <div className="kt-pagination kt-pagination--brand">
            <ul className="kt-pagination__links">
              <li className="kt-pagination__link--first">
                <Link to=""><i className="fa fa-angle-double-left kt-font-brand"></i></Link>
              </li>
              <li className="kt-pagination__link--next">
                <Link to=""><i className="fa fa-angle-left kt-font-brand"></i></Link>
              </li>
              <li>
                <Link to="">...</Link>
              </li>
              ...
              <li className="kt-pagination__link--prev">
                <Link to=""><i className="fa fa-angle-right kt-font-brand"></i></Link>
              </li>
              <li className="kt-pagination__link--last">
                <Link to=""><i className="fa fa-angle-double-right kt-font-brand"></i></Link>
              </li>
            </ul>
